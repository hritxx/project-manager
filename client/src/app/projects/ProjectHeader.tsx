    ...
    <div className="px-4 xl:px-6">
      ...
      <div className="pb-6 pt-6 lg:pb-4 lg:pt-8">
        <Header
          ...
          buttonComponent={
            <button
              className="bg flex items-center rounded-md bg-blue-primary px-3 py-2 text-white hover:bg-blue-600"
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <input
              ...
              className="dark: dark rounded-md border py-1 pl-10 pr-4 focus:outline-none dark:border-dark-secondary dark:bg-dark-secondary dark:text-white"
            />
